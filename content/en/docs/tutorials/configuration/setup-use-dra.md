...
## About the example DRA driver {#about-example-dra-driver}

This tutorial uses an example DRA driver that's maintained by the
[Node Special Interest Group](https://github.com/kubernetes/community/blob/master/sig-node/README.md).
The example driver simulates multiple GPU devices in the cluster, which you'll
allocate to your Pods in this tutorial.
...
* [Install the DRA example driver](https://github.com/kubernetes-sigs/dra-example-driver?tab=readme-ov-file#quickstart-and-demo).
...
* Create a DeviceClass to define a category of devices.
* Claim resources from the DeviceClass.
